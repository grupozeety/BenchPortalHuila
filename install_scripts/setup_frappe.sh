...
install_bench() {
	run_cmd sudo su $FRAPPE_USER -c "cd /home/$FRAPPE_USER && git clone https://github.com/grupozeety/BenchPortalHuila.git --branch $BENCH_BRANCH bench-repo"
...
setup_bench() {
	...
	ERPNEXT_APPS_JSON="https://raw.githubusercontent.com/grupozeety/installerpnext/master/erpnext-apps.json"
	if $SETUP_PROD; then
		FRAPPE_BRANCH="master"
		ERPNEXT_APPS_JSON="https://raw.githubusercontent.com/grupozeety/installerpnext/master/erpnext-apps-master.json"
	fi
